...
pub mod python_stub {
    ...
    pub mod exceptions {
        pub type PyException = String;
        pub type PyValueError = String;
        pub type PyRuntimeError = String;
    }
}
...
#[cfg(not(feature = "python"))]
/// Token cost tracking for model usage (stub version).
#[derive(Debug, Clone)]
pub struct PyTokenCost {
    pub input_cost_per_million: Option<f64>,
    pub output_cost_per_million: Option<f64>,
...
#[cfg(not(feature = "python"))]
/// Model capabilities and features (stub version).
#[derive(Debug, Clone)]
pub struct PyCapabilities {
    pub text_generation: bool,
    pub image_generation: bool,
