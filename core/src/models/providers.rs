...
/// Conversion from old ProviderConfig to new ProviderInstance.
#[allow(deprecated)]
impl From<crate::models::provider_config::ProviderConfig> for ProviderInstance {
    fn from(config: crate::models::provider_config::ProviderConfig) -> Self {
        ...
        Self {
            id: String::new(),  // ProviderConfig doesn't have ID
            provider_type: String::new(),  // ProviderConfig doesn't have provider_type
            base_url: String::new(),  // ProviderConfig doesn't have base_url
            api_key,
...
/// Conversion from new ProviderInstance to old ProviderConfig.
#[allow(deprecated)]
