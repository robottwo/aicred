...
impl MigrationConfig {
    ...
    #[must_use]
    pub const fn with_unique_ids(mut self, generate: bool) -> Self {
    ...
    #[must_use]
    pub const fn with_auto_activation(mut self, auto_activate: bool) -> Self {
    ...
    #[must_use]
    pub const fn with_metadata_preservation(mut self, preserve: bool) -> Self {
