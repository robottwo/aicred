...
impl ProviderInstances {
    ...
    #[must_use] pub fn from_instances(instances: Vec<ProviderInstance>) -> Self {
    ...
    #[must_use] pub fn get_instance(&self, id: &str) -> Option<&ProviderInstance> {
    ...
    #[must_use] pub fn all_instances(&self) -> Vec<&ProviderInstance> {
    ...
    #[must_use] pub fn instances_by_type(&self, provider_type: &str) -> Vec<&ProviderInstance> {
        self.instances
            .values()
    ...
    #[must_use] pub fn active_instances(&self) -> Vec<&ProviderInstance> {
        self.instances
            .values()
    ...
    #[must_use] pub fn active_instances_by_type(&self, provider_type: &str) -> Vec<&ProviderInstance> {
        self.instances
            .values()
    ...
    #[must_use] pub fn instances_with_valid_keys(&self) -> Vec<&ProviderInstance> {
        self.instances
            .values()
    ...
    #[must_use] pub fn all_models(&self) -> Vec<&crate::models::Model> {
        self.instances
            .values()
    ...
    #[must_use] pub fn active_models(&self) -> Vec<&crate::models::Model> {
    ...
    #[must_use] pub fn instance_ids(&self) -> Vec<&String> {
        self.instances.keys().collect()
    }

    /// Gets all provider types present in the collection.
    #[must_use] pub fn provider_types(&self) -> Vec<&String> {
